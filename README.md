...
* [ ] User can configure advanced search filters such as:
  ...
  * [X] Color filter (Color, Gray) - color filter does not work, have to use imagec filter
  * [X] File Type (png, jpg, gif, bmp) - original requirement not working so change to this filter
  * [X] Site (espn.com)
...
* [X] When search with filter returns no image, a "search result no image" view is displayed vs grid view
